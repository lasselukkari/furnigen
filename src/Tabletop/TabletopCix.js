...
export default function ApronCix({
  ...
  G1001_1001.setStartPoint({ X: 0, Y: 800 });
  G1001_1001.addLineEp({ ID: 100, XE: 0, YE: 0, ZE: 0 });
  G1001_1001.addLineEp({ ID: 101, XE: 1000, YE: 0, ZE: 0 });
  G1001_1001.addLineEp({ ID: 102, XE: 1000, YE: 800, ZE: 0 });
  G1001_1001.addLineEp({ ID: 103, XE: 0, YE: 800, ZE: 0 });
