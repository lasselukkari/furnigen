...
export default function ApronCix({
    ...
    G1001_1011.addLineTo({ XE: width - 10, YE: height });
    ...
    G1001_1013.addLineTo({ XE: width - 10, YE: height });
    ...
    G1001_1085.addLineTo({ ID: 100, XE: 20, YE: (height - pinHeight) / 2 });
    G1001_1085.addArcTo({ ID: 101, X2: 15, Y2: height / 2, XE: 20, YE: ((height - pinHeight) / 2) + pinHeight });
    ...
    G1001_1086.addLineTo({ ID: 100, XE: width - 20, YE: (height - pinHeight) / 2 });
    G1001_1086.addArcTo({ ID: 101, X2: width - 15, Y2: height / 2, XE: width - 20, YE: ((height - pinHeight) / 2) + pinHeight });
